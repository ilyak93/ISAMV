...
color_raw = o3d.geometry.Image(np_right_im)
depth_raw = o3d.geometry.Image(projected_depth[:np_right_im.shape[0], :np_right_im.shape[1]])
...
points_3d_left = XYZ[points_2d[: points_2d.shape[0] // 2, 0],
                     points_2d[: points_2d.shape[0] // 2, 1], :]
np.savez("points_3d_left.npz", points_3d_left)
