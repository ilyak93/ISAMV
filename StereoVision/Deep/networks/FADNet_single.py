...
from networks.DispNetC_single import DispNetC_single
from networks.DispNetRes import DispNetRes
from networks.DispNetRes_single import DispNetRes_single
from networks.submodules import *
import matplotlib.pyplot as plt



class FADNet_single(nn.Module):

    def __init__(self, batchNorm=True, lastRelu=False, resBlock=True, maxdisp=-1, input_channel=3):
        super(FADNet_single, self).__init__()
        ...
        self.dispnetc = DispNetC_single(self.batchNorm, maxdisp=self.maxdisp, input_channel=input_channel)
        ...
        in_planes = 3 * input_channel
        self.dispnetres = DispNetRes_single(in_planes, self.batchNorm, lastRelu=self.lastRelu, maxdisp=self.maxdisp,
