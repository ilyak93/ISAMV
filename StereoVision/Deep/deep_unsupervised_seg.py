...
parser.add_argument('--scribble', action='store_true', default=False,
                    help='use scribbles')
parser.add_argument('--nChannel', metavar='N', default=50, type=int,
                    help='number of channels')
parser.add_argument('--maxIter', metavar='T', default=1000, type=int,
                    help='number of maximum iterations')
parser.add_argument('--minLabels', metavar='minL', default=30, type=int,
                    help='minimum number of labels')
parser.add_argument('--lr', metavar='LR', default=0.0001, type=float,
                    help='learning rate')
...
# load image
im = cv2.imread("C:\dataset/rs-ptc_floor1/100color.png")

mat = scipy.io.loadmat("C:\dataset/rs-ptc_floor1/100.mat")['xyz_matrix']
mat[np.isnan(mat)] = 0
